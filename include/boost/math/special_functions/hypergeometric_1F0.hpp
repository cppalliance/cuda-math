...
BOOST_MATH_GPU_ENABLED inline T hypergeometric_1F0_imp(const T& a, const T& z, const Policy& pol)
{
   constexpr auto function = "boost::math::hypergeometric_1F0<%1%,%1%>(%1%, %1%)";
...
BOOST_MATH_GPU_ENABLED inline tools::promote_args_t<T1, T2> hypergeometric_1F0(T1 a, T2 z, const Policy&)
{
...
BOOST_MATH_GPU_ENABLED inline tools::promote_args_t<T1, T2> hypergeometric_1F0(T1 a, T2 z)
{
